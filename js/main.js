...
function map(n) {
	...
	var locations = [
		[new google.maps.LatLng(52.294147, 104.316424)],
		[new google.maps.LatLng(50.700055, 20.5513694)],
		[new google.maps.LatLng(50.809055, 27.5813694)],
...
let menuBody = document.querySelector(".header-top-menu__menu");
if (iconMenu) {
...
function popupOpen(pl, v) {
	...
	if (!$('.hedear-ourwork__more').hasClass('active')) {
